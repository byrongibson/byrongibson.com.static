...
!function(window, undefined) {
    ...
    function css_defaultDisplay(nodeName) {
        ...
        return display || (display = actualDisplay(nodeName, doc), // If the simple way fails, read from inside an iframe
        "none" !== display && display || (// Use the already-created iframe if possible
        ...
        doc.close(), display = actualDisplay(nodeName, doc), iframe.detach()), // Store the correct default display
 ...
 */
    ...
    jQuery.fn = jQuery.prototype = {
        ...
        init: function(selector, context, rootjQuery) {
            ...
            if ("string" == typeof selector) {
                ...
                return elem = document.getElementById(match[2]), // Check parentNode to catch when Blackberry 4.6 returns
                // nodes that are no longer in the document #6963
                elem && elem.parentNode && (// Inject the element directly into the jQuery object
                this.length = 1, this[0] = elem), this.context = document, this.selector = selector, 
                this;
            }
        ...
        get: function(num) {
            return null == num ? // Return a 'clean' array
            this.toArray() : // Return just the object
            0 > num ? this[this.length + num] : this[num];
        },
    ...
    jQuery.fn.init.prototype = jQuery.fn, jQuery.extend = jQuery.fn.extend = function() {
        ...
        proxy: function(fn, context) {
            ...
            jQuery.isFunction(fn) ? (// Simulated bind
        ...
        return readyList || (readyList = jQuery.Deferred(), // Catch cases where $(document).ready() is called after the browser event has already occurred.
        // we once tried to use readyState "interactive" here, but it caused issues like the one
        // discovered by ChrisS here: http://bugs.jquery.com/ticket/12282#comment:15
        "complete" === document.readyState ? // Handle it asynchronously to allow scripts the opportunity to delay ready
        setTimeout(jQuery.ready) : (// Use the handy event callback
 ...
 */
        ...
        runescape = new RegExp("\\\\([\\da-f]{1,6}" + whitespace + "?|(" + whitespace + ")|.)", "ig"), funescape = function(_, escaped, escapedWhitespace) {
            ...
            0 > high ? String.fromCharCode(high + 65536) : // Supplemental Plane codepoint (surrogate pair)
            String.fromCharCode(55296 | high >> 10, 56320 | 1023 & high);
        };
 ...
 */
        setDocument = Sizzle.setDocument = function(node) {
            ...
            parent && parent.attachEvent && parent !== parent.top && parent.attachEvent("onbeforeunload", function() {
                setDocument();
            }), /* Attributes
	---------------------------------------------------------------------- */
            // Support: IE<8
	...
	---------------------------------------------------------------------- */
            ...
            support.getElementsByClassName = assert(function(div) {
                ...
                return div.innerHTML = "<div class='a'></div><div class='a i'></div>", // Support: Safari<4
	...
	---------------------------------------------------------------------- */
            ...
            rbuggyQSA = [], (support.qsa = rnative.test(doc.querySelectorAll)) && (// Build QSA regex
	...
	---------------------------------------------------------------------- */
            ...
            sortOrder = docElem.compareDocumentPosition ? function(a, b) {
                ...
                return compare ? // Disconnected nodes
                1 & compare || !support.sortDetached && b.compareDocumentPosition(a) === compare ? // Choose the first element that is related to our preferred document
                a === doc || contains(preferredDoc, a) ? -1 : b === doc || contains(preferredDoc, b) ? 1 : sortInput ? indexOf.call(sortInput, a) - indexOf.call(sortInput, b) : 0 : 4 & compare ? -1 : 1 : a.compareDocumentPosition ? -1 : 1;
            } : function(a, b) {
        ...
        getText = Sizzle.getText = function(elem) {
            ...
            preFilter: {
                ATTR: function(match) {
                    ...
                    match[3] = (match[4] || match[5] || "").replace(runescape, funescape), "~=" === match[2] && (match[3] = " " + match[3] + " "), 
                    match.slice(0, 4);
                },
				...
				8 y of y-component
			*/
                    return match[1] = match[1].toLowerCase(), "nth" === match[1].slice(0, 3) ? (// nth-* requires argument
                    match[3] || Sizzle.error(match[0]), // numeric x and y parameters for Expr.filter.CHILD
                ...
                PSEUDO: function(match) {
                    ...
                    return matchExpr.CHILD.test(match[0]) ? null : (// Accept quoted arguments as-is
                    match[3] && match[4] !== undefined ? match[2] = match[4] : unquoted && rpseudo.test(unquoted) && (// Get excess from tokenize (recursively)
            ...
            filter: {
                ...
                PSEUDO: function(pseudo, argument) {
                    ...
                    // arguments are needed to create the filter function
                    // just as Sizzle does
                    return fn[expando] ? fn(argument) : // But maintain support for old signatures
 ...
 */
    jQuery.Callbacks = function(options) {
        ...
        Deferred: function(func) {
            ...
            return promise.pipe = promise.then, // Add list-specific methods
            jQuery.each(tuples, function(i, tuple) {
        ...
        // Finish early in limited environments
        return input.type ? (input.type = "checkbox", // Support: Safari 5.1, iOS 5.1, Android 4.x, Android 2.3
        ...
        support.reliableMarginRight = !0, support.boxSizingReliable = !0, support.pixelPosition = !1, 
        ...
        support.radioValue = "t" === input.value, // #11217 - WebKit loses check when the name is after the checked attribute
        input.setAttribute("checked", "t"), input.setAttribute("name", "t"), fragment.appendChild(input), 
        // Support: Safari 5.1, Android 4.x, Android 2.3
        // old WebKit doesn't clone checked state correctly in fragments
        support.checkClone = fragment.cloneNode(!0).cloneNode(!0).lastChild.checked, // Support: Firefox, Chrome, Safari
        // Beware of CSP restrictions (https://developer.mozilla.org/en/Security/CSP)
        support.focusinBubbles = "onfocusin" in window, div.style.backgroundClip = "content-box", 
...
*/
    ...
    Data.uid = 1, Data.accepts = function(owner) {
        ...
        access: function(owner, key, value) {
            ...
            stored !== undefined ? stored : this.get(owner, jQuery.camelCase(key))) : (// [*]When the key is not a string, or both a key and value
            // are specified, set or extend (existing objects) with either:
            //
            //   1. An object of properties
            //   2. A key and value
            //
            this.set(owner, key, value), value !== undefined ? value : key);
        },
        remove: function(owner, key) {
            ...
            if (key === undefined) this.cache[unlock] = {}; else {
                ...
                name = camel, name = name in cache ? [ name ] : name.match(core_rnotwhite) || [])), 
                i = name.length;
        ...
        data: function(key, value) {
            ...
            return "object" == typeof key ? this.each(function() {
                ...
                if (elem && value === undefined) {
                    ...
                    // with the key as-is
                    data = data_user.get(elem, key), data !== undefined) return data;
                    if (// Attempt to get data from the cache
                    // with the key camelized
                    data = data_user.get(elem, camelKey), data !== undefined) return data;
                    if (// Attempt to "discover" the data in
                    // HTML5 custom data-* attrs
                    data = dataAttr(elem, camelKey, undefined), data !== undefined) return data;
                } else // Set the data...
                this.each(function() {
    ...
    jQuery.fn.extend({
        ...
        val: function(value) {
            var hooks, ret, isFunction, elem = this[0];
            {
                ...
                "string" == typeof ret ? // handle most common string cases
        ...
        attr: function(elem, name, value) {
            ...
            return typeof elem.getAttribute === core_strundefined ? jQuery.prop(elem, name, value) : (// All attributes are lowercase
        ...
        prop: function(elem, name, value) {
            ...
            notxml && (// Fix name and attach hooks
            name = jQuery.propFix[name] || name, hooks = jQuery.propHooks[name]), value !== undefined ? hooks && "set" in hooks && (ret = hooks.set(elem, value, name)) !== undefined ? ret : elem[name] = value : hooks && "get" in hooks && null !== (ret = hooks.get(elem, name)) ? ret : elem[name];
        },
        propHooks: {
            tabIndex: {
                get: function(elem) {
    ...
    boolHook = {
        set: function(elem, value, name) {
            return value === !1 ? // Remove boolean attributes when set to false
 ...
 */
    jQuery.event = {
        ...
        trigger: function(event, data, elem, onlyHandlers) {
            ...
            special = jQuery.event.special[type] || {}, onlyHandlers || !special.trigger || special.trigger.apply(elem, data) !== !1)) {
                ...
                return event.type = type, // If nobody prevented the default action, do it now
                onlyHandlers || event.isDefaultPrevented() || special._default && special._default.apply(eventPath.pop(), data) !== !1 || !jQuery.acceptData(elem) || // Call a native DOM method on the target with the same name name as the event.
                // Don't do default actions on window, that's where global variables be (#6170)
                ontype && jQuery.isFunction(elem[type]) && !jQuery.isWindow(elem) && (// Don't re-trigger an onFOO event when we call its FOO() method
        ...
        fix: function(event) {
            ...
            return event.target || (event.target = document), // Support: Safari 6.0+, Chrome < 28
            // Target should not be a text node (#504, #13143)
            3 === event.target.nodeType && (event.target = event.target.parentNode), fixHook.filter ? fixHook.filter(event, originalEvent) : event;
        },
        special: {
            load: {
        ...
        // Allow instantiation without the 'new' keyword
        return this instanceof jQuery.Event ? (// Event object
        ...
        this.isDefaultPrevented = src.defaultPrevented || src.getPreventDefault && src.getPreventDefault() ? returnTrue : returnFalse) : this.type = src, 
    ...
    jQuery.support.focusinBubbles || jQuery.each({
        ...
        off: function(types, selector, fn) {
            ...
            return (selector === !1 || "function" == typeof selector) && (// ( types [, fn] )
            fn = selector, selector = undefined), fn === !1 && (fn = returnFalse), this.each(function() {
    ...
    jQuery.fn.extend({
        ...
        index: function(elem) {
            ...
            // No argument, return index in parent
            return elem ? // index in selector
            "string" == typeof elem ? core_indexOf.call(jQuery(elem), this[0]) : core_indexOf.call(this, // If it receives a jQuery object, the first element is used
        ...
        jQuery.fn[name] = function(until, selector) {
            ...
            guaranteedUnique[name] || jQuery.unique(matched), // Reverse order for parents* and prev-derivatives
    ...
    wrapMap.th = wrapMap.td, jQuery.fn.extend({
        ...
        domManip: function(args, callback, allowIntersection) {
            ...
            first)) {
                ...
                rscriptType.test(node.type || "") && !data_priv.access(node, "globalEval") && jQuery.contains(doc, node) && (node.src ? // Hope ajax is available...
                jQuery._evalUrl(node.src) : jQuery.globalEval(node.textContent.replace(rcleanScript, "")));
            }
            return this;
        }
    }), jQuery.each({
        ...
        clone: function(elem, dataAndEvents, deepDataAndEvents) {
            ...
            // Support: IE >= 9
            // Fix Cloning issues
            if (!(jQuery.support.noCloneChecked || 1 !== elem.nodeType && 11 !== elem.nodeType || jQuery.isXMLDoc(elem))) for (// We eschew Sizzle here for performance reasons: http://jsperf.com/getall-vs-sizzle/2
    ...
    jQuery.fn.extend({
        ...
        style: function(elem, name, value, extra) {
            ...
            if (elem && 3 !== elem.nodeType && 8 !== elem.nodeType && elem.style) {
                ...
                hooks && "get" in hooks && (ret = hooks.get(elem, !1, extra)) !== undefined ? ret : style[name] : (type = typeof value, 
                ...
                null == value || "number" === type && isNaN(value) || (// If a number was passed in, add 'px' to the (except for certain CSS properties)
        ...
        css: function(elem, name, extra, styles) {
            ...
            hooks && "get" in hooks && (val = hooks.get(elem, !0, extra)), // Otherwise, if a way to get the computed value exists, use that
            val === undefined && (val = curCSS(elem, name, styles)), //convert "normal" to computed value
        ...
        rnumnonpx.test(ret) && rmargin.test(name) && (// Remember the original values
    ...
    ajaxLocParts = rurl.exec(ajaxLocation.toLowerCase()) || [], jQuery.fn.load = function(url, params, callback) {
        ...
        return off >= 0 && (selector = url.slice(off), url = url.slice(0, off)), // If it's a function
        jQuery.isFunction(params) ? (// We assume that it's the callback
        callback = params, params = undefined) : params && "object" == typeof params && (type = "POST"), 
    ...
    jQuery.ajaxPrefilter("json jsonp", function(s, originalSettings, jqXHR) {
        ...
        // Handle iff the expected data type is "jsonp" or we have a parameter to set
        return jsonProp || "jsonp" === s.dataTypes[0] ? (// Get callback name, remembering preexisting value associated with it
            ...
            send: function(headers, complete) {
                ...
                callback = function(type) {
                    return function() {
                        ...
                        "abort" === type ? xhr.abort() : "error" === type ? complete(// file protocol always yields status 0, assume 404
                        xhr.status || 404, xhr.statusText) : complete(xhrSuccessStatus[xhr.status] || xhr.status, xhr.statusText, // Support: IE9
    ...
    jQuery.Animation = jQuery.extend(Animation, {
        ...
        _default: {
            get: function(tween) {
                ...
                result = jQuery.css(tween.elem, tween.prop, ""), result && "auto" !== result ? result : 0) : tween.elem[tween.prop];
            },
            set: function(tween) {
    ...
    jQuery.each({
        ...
        (null == opt.queue || opt.queue === !0) && (opt.queue = "fx"), // Queueing
    ...
    jQuery.fx.step = {}, jQuery.expr && jQuery.expr.filters && (jQuery.expr.filters.animated = function(elem) {
        ...
        return docElem = doc.documentElement, jQuery.contains(docElem, elem) ? (// If we don't have gBCR, just use 0,0 rather than error
        ...
        jQuery.each({
            ...
            jQuery.fn[funcName] = function(margin, value) {
                ...
                return jQuery.access(this, function(elem, type, value) {
                    var doc;
                    return jQuery.isWindow(elem) ? elem.document.documentElement["client" + name] : // Get document width or height
                    9 === elem.nodeType ? (doc = elem.documentElement, Math.max(elem.body["scroll" + name], doc["scroll" + name], elem.body["offset" + name], doc["offset" + name], doc["client" + name])) : value === undefined ? // Get width or height on the element, requesting but not forcing parseFloat
    ...
    module.exports = jQuery : // Register as a named AMD module, since jQuery can be concatenated with other
