...
window.Modernizr = function(window, document, undefined) {
    ...
    function testDOMProps(props, obj, elem) {
        for (var i in props) {
            ...
            return elem === !1 ? props[i] : // let's bind a function
            is(item, "function") ? item.bind(elem || obj) : item;
        }
        return !1;
    }
    /*>>testallprops*/
    ...
    function webforms() {
        ...
        Modernizr.input = function(props) {
            ...
            return attrs.list && (// safari false positive's on datalist: webk.it/74252
    ...
    var featureName, hasOwnProp, version = "2.6.2", Modernizr = {}, /*>>cssclasses*/
    ...
    injectElementWithStyles = function(rule, callback, nodes, testnames) {
        ...
        (body ? div : fakeBody).innerHTML += style, fakeBody.appendChild(div), body || (//avoid crashing IE8, if background image is used
        ...
        docElement.appendChild(fakeBody)), ret = callback(div, rule), // If this is done after page load we don't want to remove the body so check if body exists
    ...
    isEventSupported = function() {
        function isEventSupported(eventName, element) {
            ...
            return isSupported || (// If it has no `setAttribute` (i.e. doesn't implement Node interface), try generic element
            element.setAttribute || (element = document.createElement("div")), element.setAttribute && element.removeAttribute && (element.setAttribute(eventName, ""), 
            isSupported = is(element[eventName], "function"), // If property was created, "remove it" (by setting value to `undefined`)
            is(element[eventName], "undefined") || (element[eventName] = undefined), element.removeAttribute(eventName))), 
    ...
    tests.cssanimations = function() {
        ...
        return setCss(// legacy webkit syntax (FIXME: remove when syntax not in use anymore)
        (str1 + "-webkit- ".split(" ").join(str2 + str1) + // standard syntax             // trailing 'background-image:'
        prefixes.join(str3 + str1)).slice(0, -str1.length)), contains(mStyle.backgroundImage, "gradient");
        ...
        return ret && "webkitPerspective" in docElement.style && // Webkit allows this media query to succeed only if the feature is enabled.
    ...
    return Modernizr.input || webforms(), /*>>webforms*/
    /**
    ...
    setCss(""), modElem = inputElem = null, function(window, document) {
       ...
       */
        function shivDocument(ownerDocument) {
            ...
            return !html5.shivCSS || supportsHtml5Styles || data.hasCSS || (data.hasCSS = !!addStyleSheet(ownerDocument, // corrects block display not defined in IE6/7/8/9
    ...
    enableClasses ? " js " + classes.join(" ") : ""), Modernizr;
}(this, this.document);
